...
const NAV_ITEMS = [
  { key: 'home', label: 'בית', path: '/', Icon: HomeIcon },
  { key: 'activities', label: 'פעילויות', path: '/activities', Icon: CategoryIcon },
  { key: 'saved', label: 'שמורים', path: { pathname: '/my-things', params: { tab: 'saved' } }, matchPath: '/my-things', Icon: HeartIcon, requiresAuth: true },
  { key: 'profile', label: 'פרופיל', path: '/profile', Icon: UserIcon },
];
...
const styles = StyleSheet.create({
  ...
  bar: {
    flexDirection: 'row-reverse', backgroundColor: colors.card, borderTopWidth: 1, borderTopColor: colors.borderLight,
    paddingTop: 8,
  },
