...
- place_type_hint: "indoor" אם המשתמש ביקש *במפורש* בתוך מבנה/מקורה (למשל "משהו סגור", "בבית"), "outdoor" אם ביקש *במפורש* בחוץ/בטבע, אחרת null. חשוב: אל תסיק את זה מסוג הפעילות עצמו (למשל "משחקייה" לא אומרת indoor, "ממוזג" לא אומר indoor) - רק אם המשתמש ממש אמר את זה על המקום.
