// TuRu - סרגל ניווט משותף לכל עמודי הניהול: 5 קטגוריות (דשבורד/פעילויות/הוספת תוכן/
...
// לא כולל את לוגו ה-TuRu/כותרת העמוד - אלה נשארים בכל קובץ כמו שהיו, כדי שהשינוי בקבצים
...
const PRIMARY_ITEMS = [
  ...
  { key: 'settlement-review', href: '/settlement-review', label: '🔎 בדיקת סריקה ארצית' },
