              ...
              {submitResult.count > 1
                ? `נוספו ${submitResult.count} רשומות (אחת לכל שילוב של קטגוריה+סוג שבחרתם)` +
                  (submitResult.archivedCount > 0
                    ? `. ${submitResult.archivedCount} מתוכן נשמרו בארכיון - סוג פעילות שהאפליקציה כרגע לא מציגה (חוג/קייטנה שדורש הרשמה קבועה). השאר נשלחו לצוות WABBIT לבדיקה, ויופיעו באפליקציה לאחר אישור`
                    : '. כולן נשלחו לצוות WABBIT לבדיקה, ותופענה באפליקציה לאחר אישור')
                : submitResult.archivedCount > 0
                  ? 'הפעילות נשמרה - זה סוג פעילות שהאפליקציה כרגע לא מציגה (חוג/קייטנה שדורש הרשמה קבועה)'
                  : 'הפעילות נשלחה לצוות WABBIT לבדיקה, ותופיע באפליקציה לאחר אישור'}
            </Text>
